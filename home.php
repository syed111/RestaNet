      ...
      <div class="site-wrapper-inner">
        ...
        <div class="cover-container">
          ...
          <div class="inner cover">
            <h1 class="cover-heading">OnTraNetBD</h1>
            <p class="lead">Travel Ontology of Bangladesh</p>
            <p class="lead">
              <a href="search.php" class="btn btn-lg btn-primary">Search</a>
              <a href="service.php" class="btn btn-lg btn-primary">Service</a>
            </p>
          </div>
